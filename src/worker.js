...
function renderOrderEmailHtml({ name, email, note, cart, total, ip }) {
  ...
  const noteBlock = note
    ? `<p style="margin:18px 0 0;padding:10px 14px;background:#f4ecd7;border-left:3px solid #8a2a22;color:#1a1512;font-style:italic;">${escapeHtml(note)}</p>`
    : '';

  return `<!doctype html>
<html><body style="font-family:'Cormorant Garamond',Georgia,serif;color:#1a1512;background:#ece3cf;padding:24px;">
