...
export const PRODUCTS = [
  // 【一、花神守護系列 — 修復與潤澤】
  {
    ...
    zh: '海棠修復 · 碧玉',
    subtitle: '瓊崖海棠修復皂',
    photos: ['/images/products/海棠/01.png'],
    weight: '105 g',
    price: 380,
  ...
  },
  {
    ...
    zh: '槐花蜜潤 · 霧蜜',
    subtitle: '霧峰蜜 · 潤玉皂',
    photos: ['/images/products/霧蜜/01.png'],
    weight: '105 g',
    price: 300,
    skinType: '極乾燥肌、熟齡肌。',
    coreIngredients:
  ...
  },
  {
    ...
    zh: '綠豆清芳 · 澡豆',
    subtitle: '潤玉澡豆',
    photos: ['/images/products/綠豆/01.png'],
    weight: '100 g',
    price: 280,
  ...
  },
  {
    ...
    zh: '藍蝶清瑩 · 蝶豆',
    subtitle: '蝶豆花美顏皂',
    photos: ['/images/products/蝶豆花/01.png'],
    weight: '100 g',
    price: 320,
  ...
  // 【二、花韻時節系列 — 風土與暖心】
  {
    ...
    zh: '金盞舒緩 · 長金',
    subtitle: '長濱金 · 舒膚皂',
    photos: ['/images/products/金盞花/01.png'],
    weight: '110 g',
    price: 320,
  ...
  },
  {
    ...
    zh: '稻花暖心 · 星米',
    subtitle: '三星米 · 暖心皂',
    photos: ['/images/products/大米/01.png'],
    weight: '105 g',
    price: 300,
  ...
  },
  {
    ...
    zh: '杜康醉月 · 酒粕',
    subtitle: '醉月酒粕',
    photos: ['/images/products/酒粕/01.png'],
    weight: '105 g',
    price: 320,
  ...
  },
  {
    ...
    zh: '桂月流金 · 桂花',
    subtitle: '桂花潤膚皂',
    photos: ['/images/products/桂花/01.png'],
    weight: '105 g',
    price: 360,
  ...
  // 【三、花露淨髮餅系列 — 髮沐】
  {
    ...
    zh: '山茶淨髮',
    subtitle: '植萃髮餅',
    photos: ['/images/products/山茶淨髮/01.png'],
    weight: '90 g',
    price: 320,
  ...
  },
  {
    ...
    zh: '茉莉沐膚',
    subtitle: '香氛沐浴餅',
    photos: ['/images/products/茉莉沐膚/01.png'],
    weight: '100 g',
    price: 320,
  ...
  // 【四、全能日常系列 — 一皂到底】
  {
    ...
    zh: '一皂到底 · 清爽款',
    subtitle: '水仙清透',
    photos: ['/images/products/一皂到底清爽/01.png'],
    weight: '110 g',
    price: 320,
  ...
  },
  {
    ...
    zh: '一皂到底 · 保濕款',
    subtitle: '待命名',
    photos: ['/images/products/一皂到底保濕/01.png'],
    weight: '110 g',
    price: 320,
