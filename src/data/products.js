...
export const PRODUCTS = [
  // 【一、花神守護系列 — 滋養與柔潤】
  {
    ...
    photos: [
      ...
      '/images/products/海棠/09.jpg',
      '/images/products/海棠/10.jpg',
    ],
    weight: '105 g',
    price: 380,
  ...
  },
  {
    ...
    photos: [
      ...
      '/images/products/綠豆/09.jpg',
      '/images/products/綠豆/10.jpg',
    ],
    weight: '100 g',
    price: 280,
  ...
  // 【二、花韻時節系列 — 風土與暖心】
  {
    ...
    photos: [
      ...
      '/images/products/金盞花/09.jpg',
      '/images/products/金盞花/10.jpg',
    ],
    weight: '110 g',
    price: 320,
  ...
  // 【三、花露淨髮餅系列 — 髮沐】
  {
    ...
    photos: [
      ...
      '/images/products/山茶淨髮/07.jpg',
      '/images/products/山茶淨髮/08.jpg',
    ],
    weight: '90 g',
    price: 320,
  ...
  },
  {
    ...
    photos: [
      ...
      '/images/products/茉莉沐膚/07.jpg',
      '/images/products/茉莉沐膚/08.jpg',
      '/images/products/茉莉沐膚/09.jpg',
    ],
    weight: '100 g',
    price: 320,
  ...
  // 【四、全能日常系列 — 一皂到底】
  {
    ...
    photos: [
      ...
      '/images/products/一皂到底清爽/06.jpg',
      '/images/products/一皂到底清爽/07.jpg',
      '/images/products/一皂到底清爽/08.jpg',
    ],
    weight: '110 g',
    price: 320,
  ...
  },
  {
    ...
    photos: [
      ...
      '/images/products/一皂到底保濕/07.jpg',
      '/images/products/一皂到底保濕/08.jpg',
    ],
    weight: '110 g',
    price: 320,
