...
export function Process() {
  ...
  const ingredients = [
    ...
    { zh: '瓊崖海棠子', lat: 'Calophyllum inophyllum', origin: '蘭嶼 · 海岸', ratio: '~5%', benefit: '潤澤',
      photo: '/images/ingredients/海棠子.png',
      note: '蘭嶼海岸的瓊崖海棠子，冷壓出油 ── 富含 calophyllolide，是為敏弱與易乾肌而備的木質深油。海棠潤澤皂的主角即此。' },
    { zh: '白芷', lat: 'Angelica dahurica', origin: '中部山區', ratio: '~2%', benefit: '淡化',
      photo: '/images/ingredients/白芷.png',
      note: '古方中常見的草本，磨成細粉於 trace 後拌入。淡米色、無強烈氣味 ── 常被用來淡化暗沉。' },
    ...
    { zh: '蝶豆花', lat: 'Clitoria ternatea', origin: '屏東', ratio: '~2%', benefit: '天然草本',
      photo: '/images/ingredients/蝶豆花.png',
      note: '屏東種的蝶豆花，鮮藍的南島草本；入冷製皂後，鹼性讓藍色靜靜轉淡、沉成溫潤奶色 ── 真材料、不假化學色粉。' },
    ...
    { zh: '金盞花', lat: 'Calendula officinalis', origin: '臺東 · 長濱', ratio: '~5%', benefit: '潤澤舒膚',
