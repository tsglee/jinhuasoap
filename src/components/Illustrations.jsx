...
// Brand palette used by all illustrations. Kept module-internal so this file
// stays "components only" for Vite Fast Refresh; consumers should import from
...
export function PaperBg({ tone = 'paper', children, style = {} }) {
  const bg =
    tone === 'deep'
      ? ART.sumi
      : tone === 'red'
    ...
    {[
      ...
      <div
        ...
        style={{
          ...
          width: 14,
          height: 14,
          borderTop: `1px solid ${ART.gold3}`,
          borderLeft: `1px solid ${ART.gold3}`,
          opacity: 0.5,
          ...p,
...
export function IllPortrait({ label = 'portrait', ratio = '3/4' }) {
  return (
    <PaperBg tone="paper" style={{ aspectRatio: ratio, width: '100%' }}>
      ...
      >
        ...
        {/* apron tie */}
        <path
          d="M120 220 L 150 235 L 180 220"
          fill="none"
          stroke={ART.red}
          strokeWidth="1.2"
          opacity="0.8"
...
// ── Soap bar still life ───────────────────────────────────────────────────
export function IllSoap({ label, tone = 'warm', ratio = '4/5', flower = 'rose' }) {
  const palettes = {
  ...
  return (
    <PaperBg tone="paper" style={{ aspectRatio: ratio, width: '100%' }}>
      ...
      >
        ...
        {/* back drape */}
        <path
          d="M0 180 Q 100 120, 200 160 T 400 140 L 400 260 L 0 260 Z"
          fill="#c9b996"
          opacity="0.6"
        />
        ...
        <g transform="translate(260 180)" opacity="0.9">
          ...
          {flower === 'leaf' && (
            <g>
              <path
                d="M0 0 Q 20 20, 10 60 Q 0 80, -15 90"
                stroke={ART.tea}
                strokeWidth="1.5"
                fill="none"
              />
...
export function IllStep({ step = 'I', label, ratio = '4/3' }) {
  const scenes = {
    I: (
      // gather — basket with herbs
      <g>
        <ellipse cx="200" cy="260" rx="130" ry="24" fill="rgba(40,30,20,0.2)" />
        <path
          d="M100 170 L 110 260 L 290 260 L 300 170 Z"
          fill="#a08058"
          stroke={ART.gold3}
          strokeWidth="1"
        />
        ...
        {Array.from({ length: 12 }).map((_, i) => {
          ...
          return (
            <g key={i} transform={`translate(${x} ${130 + (i % 3) * 10}) rotate(${-20 + i * 5})`}>
    ...
    II: (
      // render — copper pot with steam
      <g>
        <ellipse cx="200" cy="270" rx="120" ry="18" fill="rgba(40,30,20,0.25)" />
        <path
          d="M110 200 Q 110 260, 150 270 L 250 270 Q 290 260, 290 200 Z"
          fill="#c2793a"
          stroke={ART.gold3}
          strokeWidth="1"
        />
        ...
        {[0, 1, 2].map((i) => (
          <path
            key={i}
            d={`M${170 + i * 30} 180 Q ${165 + i * 30} 140, ${180 + i * 30} 120 Q ${185 + i * 30} 90, ${170 + i * 30} 70`}
            stroke="rgba(236,227,207,0.65)"
            strokeWidth="3"
            fill="none"
            strokeLinecap="round"
          />
    ...
    III: (
      // mix the lye — stoneware jar
      <g>
        <ellipse cx="200" cy="270" rx="100" ry="16" fill="rgba(40,30,20,0.25)" />
        <path
          d="M150 120 L 140 260 L 260 260 L 250 120 Z"
          fill="#8a8068"
          stroke={ART.sumi}
          strokeWidth="1"
        />
    ...
    IV: (
      ...
      <g>
        ...
        <g transform="translate(165 20)">
          <path
            d="M0 0 L 60 0 L 65 30 Q 70 30, 75 40 L 60 50 L 0 50 Z"
            fill={ART.clay}
            stroke={ART.sumi}
            strokeWidth="0.5"
          />
...
// ── Gift box ─────────────────────────────────────────────────────────────
export function IllGiftBox({ label = 'cedar gift box', ratio = '4/3' }) {
  return (
    <PaperBg tone="deep" style={{ aspectRatio: ratio, width: '100%' }}>
      ...
      >
        ...
        <g transform="translate(60 80)">
          ...
          {/* box body */}
          <path
            d="M0 30 L 30 0 L 280 0 L 280 140 L 0 140 Z"
            fill="#8a6420"
            stroke={ART.gold1}
            strokeWidth="0.8"
          />
          ...
          <circle cx="149" cy="60" r="5" fill="#6e2019" />
        </g>
      </svg>
...
export function IllIngredient({ kind = 'olive', zh, en, benefit, ratio = '1/1' }) {
      ...
      >
        ...
        {r.kind === 'ripple' && (
          <g opacity="0.8" fill="none" stroke={r.accent} strokeWidth="0.8">
            ...
            {[0, 1, 2, 3].map((i) => (
              <path
                key={`s${i}`}
                d={`M${60 + i * 90} 180 Q ${80 + i * 90} 170, ${120 + i * 90} 180`}
                stroke="#fff"
                strokeWidth="1.5"
                opacity="0.35"
              />
            ...
            {Array.from({ length: 28 }).map((_, i) => {
              ...
              return (
                <g key={i} transform={`translate(${cx} ${cy}) rotate(${rot}) scale(${s})`}>
                  <path d="M0 -20 Q 10 0, 0 20 Q -10 0, 0 -20 Z" fill={r.bg[0]} opacity="0.85" />
                  <line
                    x1="0"
                    y1="-18"
                    x2="0"
        ...
        {r.kind === 'pour' && (
          <g>
            ...
            {/* honey drip */}
            <path
              d="M200 0 Q 195 80, 205 160 Q 200 200, 208 260"
              stroke={r.accent}
              strokeWidth="18"
              fill="none"
              strokeLinecap="round"
...
export function IllProductHero({
  tone = 'warm',
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Out-of-focus pine sprig, top-right */}
        ...
        {staging === 'bowl' && (
          <g>
            ...
            <path
              d="M150 820 Q 180 900, 280 920 L 520 920 Q 620 900, 650 820 Z"
              fill="#b59f73"
            />
            <ellipse
              cx="400"
