  ...
  privacy: {
    ...
    sections: [
      ...
      },
      {
        h: 'Cookies',
        p: [
          '我們只使用一個 localStorage 項目記住你看到哪一頁分頁（購物籃、本舍、十二花、製皂）── 不是 cookie、不追蹤個人身分。',
        ],
      },
    ],
    note: '這頁是品牌語氣版本 ── 不是律師版。若你對條款有疑問，來信給我們就好。',
  },
  returns: {
    kicker: '法律 · 退換',
    title: '退換貨辦法',
  ...
  terms: {
    ...
    sections: [
      ...
      },
      {
        h: '免責',
        p: [
          '我們的皂是「清潔用品」── 不是「藥品」、不是「化妝品」，不宣稱療效。若你對某種成分過敏（例如堅果油、蜂蜜、針葉精油），請先看商品頁的「過敏原」欄位。',
