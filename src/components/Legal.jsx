  ...
  privacy: {
    ...
    sections: [
      ...
      },
      {
        h: '存多久',
        p: [
          '訂單資料在我們信箱保存至少六年（稅法與帳務需求）。若你希望我們刪除某一筆早期訂單，用 Line 告知即可。',
        ],
      },
      {
        h: '你的權利',
        p: [
          '你可以隨時用 Line 跟我們聯絡，請我們：告知我們存了你哪些資料、更正錯誤、或在法律允許的範圍內刪除。',
        ],
      },
      {
        h: 'Cookies',
    ...
    note: '這頁用人話寫的。若對條款有疑問，加我們 Line 就好。',
  },
  returns: {
    kicker: '法律 · 退換',
    title: '退換貨辦法',
    ...
    sections: [
      ...
      },
      {
        h: '瑕疵品',
        p: [
          '若收到的皂有運送造成的破損、生產瑕疵（如裂痕、脫鹼、異味）、或寄錯款式，請在收件後三日內加 Line 跟我們聯絡，附上照片。我們會先與你確認，然後免費補寄或全額退款，運費歸我們。',
        ],
      },
      {
        h: '退貨流程',
        p: [
          '1. 加我們 Line，告知訂單編號 + 退貨原因。',
          '2. 我們回信給你退貨地址。',
    ...
    sections: [
      ...
      },
      {
        ...
        p: [
          ...
          '冷製皂須熟成四十二日以上才出貨 ── 某款若暫時缺貨，我們會主動 Line 通知預計可出貨日。',
          '我們保留因明顯標價錯誤（例如 NT$38 應為 NT$380）取消訂單的權利；遇到這種狀況會主動 Line 跟你說明。',
        ],
      },
      {
        h: '智慧財產',
        p: [
          '本網站所有文字、攝影、插畫、配方、品牌標誌均屬金花樓所有。歡迎分享連結、引用短段落；若要轉載全文或商業使用，請加我們 Line 詢問。',
          '「金花樓」品牌名與金花花卉紋樣保留權利。',
        ],
      },
      {
        h: '免責',
        p: [
          '本網站所列產品依《化粧品衛生安全管理法》歸類為「一般化粧品 · 清潔劑」。所有產品說明、文章、客戶心得僅描述清潔感受與膚況適用，不主張任何醫療效能（不能治療、修復、預防疾病或改善生理機能）。',
          '若你正在進行皮膚科治療、或有特定膚況疑慮，請以醫師建議為優先；本舍的皂是日常照護輔助，並非藥品。',
          '若你對某種成分過敏（例如堅果油、蜂蜜、針葉精油），請先看商品頁的「過敏原」欄位。',
          '每一批皂在正式出貨前都會由我們親自試用 ── 但肌膚狀況因人而異，若使用後有不適請立即停止並 Line 告知。',
        ],
      },
      {
        h: '爭議處理',
        p: [
          '若有爭議，請先加我們 Line ── 我們會在三個工作日內回覆。絕大多數問題都能直接處理掉。',
