...
const POSTS = [
...

  {
    ...
    body: [
      ...
      '一、選清潔力較高的款。本舍的綠豆清芳、藍蝶清瑩、一皂到底·清爽款月桂酸比例稍高，硬水區起泡比較不費力。',
...

  {
    ...
    body: [
      ...
      '藍蝶清瑩·蝶豆 ── 重度紫外線曝曬後（戶外、海邊）。蝶豆花的抗氧化能力幫皮膚做完運動後的「修整」── 不是治療，是減少氧化壓力的累積。',
...

  {
    ...
    body: [
      ...
      '藍蝶清瑩·蝶豆 ── 蝶豆花的抗氧化跟收斂感，對足汗特別重的人有幫助。',
...

  {
    ...
    body: [
      ...
      '藍蝶清瑩·蝶豆 ── 蝶豆花的抗氧化能力對痘痘紅腫有幫助。配方比綠豆稍清爽一點。',
