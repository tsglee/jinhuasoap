...
export const PILLARS = [
  {
    zh: '純手工',
    body:
      '每一塊皂的切、印、包，都出自我們二人的手 ── 一對夫妻，沒有別人。' +
      '不假機器、不外包代工。',
    tone: 'warm',
...
export const CREW = {
  ...
  members: [
    ...
    },
    {
      ...
      roleZh: '寫字的創作老公',
      body:
        '這一頁的字是我寫的 ── 但皂不是我做的。我的工作是把她的慢工，' +
        '用不吵的方式說給更多人聽；網站、文案、寄件回信，也都在我這一端。',
      edu:
        '我相信一個品牌應該像一封信 ── 寫得慢、讀得久、不催促。' +
        '這是我這一端的底線：不加上「amazing / premium / luxurious」這類詞彙。',
    },
  ],
};
