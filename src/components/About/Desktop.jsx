        ...
        <div>
          ...
          <div className="edu-block" style={{ maxWidth: 620 }}>
            ...
            <p className="edu-note">
              ...
              一撮桂花、一勺艾草，為的是讓皂更耐人尋味；配方本身先站得住，花材才會加分。
            </p>
          </div>
        </div>
      </section>
        ...
        >
          ...
          {(() => {
            const scene = {
              productNum: '壹',
              zh: '海棠潤澤',
              subtitle: '敏弱 · 易乾 · 熟齡 一塊潤膚',
              tagline: '為敏感、易乾、熟齡的肌膚而壓 ── 洗完柔潤不緊。',
              palette: { tone: 'cool', flower: 'rose' },
              kicker: 'NO. 01 · 潤澤',
              body: '為敏弱、易乾、走過幾道刺激的肌膚而壓。瓊崖海棠油是這方皂的主角 ── 潤澤的厚度來自它；乳油木果脂接在後面，把水分鎖住。洗時是一抹深沉的木質堅果香，泡泡細緻；沖完，肌膚柔軟、不緊不澀。',
              tags: [
                '瓊崖海棠油',
                '乳油木果脂 · 甜杏仁',
                '敏弱 · 易乾 · 熟齡',
              ...
              edu: {
                label: '設計之念',
                body: '海棠潤澤走的是五力中的「溫潤」與「滋養」 ── 瓊崖海棠油是主角，它補的是肌膚最需要的那層油脂；乳油木果脂接在後面，把那一刻鎖回的水分守住，不至於太快流失。椰子油刻意壓得低一些，是替敏弱與易乾肌留一條退路 ── 該洗的洗掉，不該帶走的就留給肌膚。',
              },
              note: 'ritual — 入夜的最後一盆溫水。一塊碧玉色的皂，洗去一日的塵與躁。',
            };
            return (
              <div
                role="button"
            ...
            {[
              {
                ...
                edu: {
                  label: '設計之念',
                  body: '髮餅有兩處較真。一是 pH 5–6 ── 弱酸，接近皮膚自然的酸鹼，洗久還是順滑。二是蠶絲蛋白：細小的多胜肽讓頭髮洗完順暢、不打結。山茶花油補一層輕脂；玉米澱粉撐起整餅的結構。',
                },
              ...
              },
              {
                ...
                subtitle: '香氛沐浴餅',
                tagline: '一塊小皂，一夜茉莉。',
                body: '茉莉花萃取粉、玉米澱粉、甘油 ── 三味為主，壓成一塊掌心大小的沐浴餅。pH 5–6，弱酸，泡沫綿密細緻，洗完依然滋潤。茉莉花是這支的主香 ── 用真實的花瓣磨成粉；水熱了，香就慢慢開了。',
                tags: [
                  '茉莉花萃取粉',
                  '玉米澱粉 · 甘油',
                  'pH 5–6',
                ...
                edu: {
                  label: '設計之念',
                  body: '沐浴餅的骨架是弱酸的表活組合 ── pH 5–6，接近皮膚自然的酸鹼，泡沫綿密又溫和。茉莉花萃取粉是植萃之妙：本舍信奉「配方先站得住，植萃才為它加分」── 香氣是錦上添花。茉莉粉量刻意壓在低位，剛剛好讓水帶出香；玉米澱粉撐起整塊小餅的結構。',
                },
              ...
              },
              {
                ...
                edu: {
                  label: '設計之念',
                  body: '金盞舒緩走的是五力中的「溫潤」與「潤澤」。長濱金盞花要先在橄欖油裡浸泡四週 ── 不靠加熱、不催 ── 讓金盞花烯與類黃酮慢慢釋進油裡，這道功夫不能省。乳油木果脂接在後面，把這道潤澤鎖在肌膚上；椰子與棕櫚油刻意壓在低位，是為敏感留一道緩衝 ── 配方厚實，但不喧鬧。',
                },
              ...
              },
              {
                ...
                subtitle: '清爽款 · 水仙清透',
                tagline: '一身汗，一塊皂，一場清。',
                body: 'SCI 弱酸表活、甜杏仁油、薰衣草粉、蠶絲蛋白液 ── 五味為主，為一身汗水後的肌膚而壓。pH 5–6 的表活組合洗完不緊不悶；甜杏仁油補上親膚的油性、蠶絲蛋白讓沖完後肌膚有絲緞感；薰衣草粉在後段釋出一抹草本氣。沖完，全身會留下微微的清涼。',
                tags: [
                  'SCI · 甜杏仁油',
                  '薰衣草粉 · 蠶絲蛋白',
                  '清爽 · 速洗',
                ...
                edu: {
                  label: '設計之念',
                  body: '清爽款的設計，把骨架壓向最輕盈的一端 ── 弱酸表活組合 (pH 5–6) 接近頭皮與肌膚的原生酸鹼，洗起來不剝、不悶；甜杏仁油補上親膚的油性，蠶絲蛋白多胜肽留下沖完的絲緞感。薰衣草粉走粉類植萃路線，量壓在低位 ── 多了會壓擠泡沫，剛好的量會在沖水那一刻釋出一陣草本氣。配方薄、洗感快 ── 為夏天、為流汗、為趕著出門的清晨而備。',
                },
