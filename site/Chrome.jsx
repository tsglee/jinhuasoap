...
function Header({ tab, setTab, tabs }) {
  return (
    <header style={{
      ...
      {/* Announcement bar */}
      <div style={{
        background: "var(--red-2)", color: "var(--gold-2)",
      ...
      <div style={{
        ...
        <button onClick={() => setTab("about")} style={{
          ...
          <div style={{
            ...
            letterSpacing: 4, color: "var(--gold-3)",
          }}>Goldenflower</div>
        </button>

        {/* Right: cart + search */}
        <div style={{
          display: "flex", justifyContent: "flex-end", gap: 22,
      ...
      <div style={{
        ...
        <div>
          <div style={{ display: "flex", alignItems: "center", gap: 14, marginBottom: 16 }}>
            ...
            <div>
              <div className="tc" style={{
                fontSize: 24, letterSpacing: 6, color: "var(--paper)",
              }}>金花樓</div>
              <div className="italic" style={{
                fontSize: 13, letterSpacing: 3, color: "var(--gold-2)",
              }}>Goldenflower Soap Works</div>
            </div>
          </div>
          <div className="italic" style={{
            fontSize: 15, lineHeight: 1.65, color: "rgba(236,227,207,0.7)",
            maxWidth: 320,
          }}>
        ...
        {[
          ...
          <div key={title}>
            <div className="mono" style={{ color: "var(--gold-2)", marginBottom: 18 }}>{title}</div>
            <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "grid", gap: 10 }}>
              {items.map(x => (
                <li key={x} className="italic" style={{ fontSize: 15, color: "rgba(236,227,207,0.85)" }}>{x}</li>
              ))}
            </ul>
          </div>
        ))}
